  ...
  return (
    <main className="min-h-screen pt-20 bg-gray-50/30">
      ...
      <section
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.65), rgba(0, 0, 0, 0.8)), url('https://images.unsplash.com/photo-1596040033229-a9821ebd058d?q=80&w=1920&auto=format&fit=crop')`,
        }}
      >
