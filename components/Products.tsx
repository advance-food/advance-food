...
export default function Products({ onProductSelect, limit }: ProductsProps) {
  const categories = [
    ...
    },
    {
      ...
      desc: "Premium golden-brown fried onions processed hygienically to deliver an exceptional crispy texture and rich, sweet caramelized flavor.",
      specs: [
        { label: "Form", value: "Crispy Flakes" },
        { label: "Color", value: "Golden Brown" },
        { label: "Oil Content", value: "Low (Well Drained)" },
        { label: "Moisture Content", value: "Max 5% (Highly Crispy)" },
