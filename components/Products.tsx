...
export default function Products({ onProductSelect, limit }: ProductsProps) {
  const categories = [
    ...
    },
    {
      ...
      subtitle: "Aromatic Spices & Seeds",
      desc: "Premium machine-cleaned coriander seeds with high volatile oil content, carrying a mild, sweet, and citrusy flavor.",
      specs: [
        { label: "Color", value: "Greenish to light brown" },
        { label: "Purity", value: "99% Machine Cleaned / Sortex" },
        { label: "Split/Whole", value: "Whole seeds" },
    ...
    },
    {
      ...
      desc: "Premium green fennel seeds dried naturally under hygienic conditions, delivering a sweet, refreshing licorice flavor.",
      specs: [
        { label: "Size", value: "Medium to Bold" },
